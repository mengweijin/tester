package com.mengweijin.tester.common.util;

import cn.hutool.core.util.ReflectUtil;
import com.alibaba.fastjson.JSONObject;
import com.mengweijin.tester.common.exception.TesterException;
...
public class TreeUtils {
    ...
    public static <T> List<T> filterBeanByPid(List<T> list, String... parentIds) throws TesterException {
        return filterBeanByRootId("id", "pid", list, parentIds);
    }

    public static <T> List<T> filterBeanByParentId(List<T> list, String... parentIds) throws TesterException {
     ...
     */
    public static <E> List<E> filterBeanByRootId(String idName, String parentIdName, List<E> list, String... parentIds) throws TesterException {
    ...
    public static <T> List<JSONObject> buildJsonBeanTreeByPid(List<T> list, String rootId) throws TesterException {
        return buildJsonBeanTree(list, rootId, "id", "pid");
    }

    public static <T> List<JSONObject> buildJsonBeanTreeByParentId(List<T> list, String rootId) throws TesterException {
