...
import com.mengweijin.tester.common.constant.Const;
...
public class CucumberMain extends Main {
    ...
    public static final String CUCUMBER_PATH = Const.PROJECT_PATH + "cucumber" + File.separatorChar;
    ...
    public static byte run(Long testTaskId) throws Throwable {
        ...
        cucumberOptionsList.add("classpath:com/mengweijin/tester/cucumber/step");
