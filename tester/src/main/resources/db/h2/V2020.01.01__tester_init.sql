...
DROP TABLE IF EXISTS AT_DATASOURCE_INFO;
CREATE TABLE AT_DATASOURCE_INFO (
...
INSERT INTO AT_DATASOURCE_INFO VALUES(1, 'h2', 'jdbc:h2:file:./h2/test;AUTO_SERVER=TRUE;DB_CLOSE_ON_EXIT=FALSE;MODE=MYSQL', 'sa', null, 'true', 'false', 'true', 'debug', 0, 1, 'system', '2020-01-01 00:00:00', 'system', '2020-01-01 00:00:00');
